...
//                        new AlertDialog.Builder(activity).setTitle("温馨提示...").setIcon(R.drawable.ic_launcher)
//                                .setMessage("该功能需要设置权限！")
...
//            }
    ...
    public static boolean isAppFirstRun(Activity activity) {
        SharedPreferences sp = activity.getSharedPreferences("vxt_first_run", Context.MODE_PRIVATE);
